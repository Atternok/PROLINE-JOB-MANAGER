...
function CompaniesDashboard({ buildingId, floorId }) {
    ...
    // =========================
    const addInvoice = async (companyId, data)=>{
    ...
    // =========================
    const addBill = async (companyId, invoiceId, data)=>{
        const company = floor.companies.find((c)=>c.id === companyId);
    ...
    const deleteBill = async (companyId, invoiceId, billId)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7b19f963._.js.map