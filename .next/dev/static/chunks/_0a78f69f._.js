...
function FloorsDashboard() {
    ...
    const deleteFloor = (id)=>{
        ...
        const index = building.floors.findIndex((f)=>f.id === id);
        if (index !== -1) building.floors.splice(index, 1);
        refresh();
    };
...
_s(FloorsDashboard, "pvxgvfUchqQRYxGxLPcXAoWyrTE=", false, function() {
    return [
...
//# sourceMappingURL=_0a78f69f._.js.map