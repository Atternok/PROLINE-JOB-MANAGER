...
function CompaniesDashboard({ buildingId, floorId }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CompaniesDashboard.useEffect": ()=>{
            const loadFloor = {
                "CompaniesDashboard.useEffect.loadFloor": async ()=>{
                    const res = await fetch("/api/buildings");
                    const data = await res.json();
                    const b = data.find({
                        "CompaniesDashboard.useEffect.loadFloor.b": (b)=>b.id === buildingId
                    }["CompaniesDashboard.useEffect.loadFloor.b"]);
                    const f = b?.floors?.find({
                        "CompaniesDashboard.useEffect.loadFloor": (fl)=>fl.id === floorId
                    }["CompaniesDashboard.useEffect.loadFloor"]);
                    if (f) setFloor(f);
                }
            }["CompaniesDashboard.useEffect.loadFloor"];
            loadFloor();
...
//# sourceMappingURL=_1f5ae505._.js.map